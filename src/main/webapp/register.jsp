...
<body class="bg-slate-100 min-h-screen flex items-center justify-center font-sans px-4 py-8">
...
<div class="w-full max-w-md bg-white border border-slate-200 rounded-2xl p-8 shadow-lg">
    ...
    <div class="text-center mb-7">
        ...
        <div class="inline-flex items-center justify-center w-14 h-14
                    bg-emerald-100 text-emerald-600 rounded-full mb-4">
